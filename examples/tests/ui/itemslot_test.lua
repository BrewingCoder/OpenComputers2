-- itemslot_test.lua -- composite item slot: texture + count + caption.
--
-- Row 1: five ItemSlots with count labels in realistic storage ranges.
-- Row 2: counts + captions (the "inventory block" pattern).
-- Row 3: edge cases — no item, no count, caption-only, big count, custom str.
...
ui.mount(mon, root)
ui.render(mon)
print("itemslot_test running - item + count + caption rendered.")
