// fluidslot_test.js -- JS mirror of fluidslot_test.lua.
//
// Composite ItemSlot: fluid + count + caption.
...
ui.mount(mon, root);
ui.render(mon);
print("fluidslot_test running - fluid + count + caption rendered; ctrl-C to exit.");
