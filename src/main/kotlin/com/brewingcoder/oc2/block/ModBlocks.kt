...
object ModBlocks {
    ...
    val CONTROL_PLANE_HOLDER: DeferredBlock<ControlPlaneBlock> = REGISTRY.registerBlock(
        "control_plane",
        { props -> ControlPlaneBlock(props) },
        BlockBehaviour.Properties.of()
            .strength(3.5f)
            .lightLevel { 8 }
    )
    val CONTROL_PLANE: ControlPlaneBlock by CONTROL_PLANE_HOLDER
}
